...
""" % mapValues)
		...
		if fnTexture:
			...
			uvData = obj.data.uv_textures[0].data # shortcut for below.
	...
	def execute(self, context):
		...
		# so let's now apply the modifiers to the current selection:
		bpy.ops.object.convert(keep_original=True)
		# new selection will consist of original and modified geometry.
		# we'll later delete all modified (i.e. geometry with applied modifiers)
